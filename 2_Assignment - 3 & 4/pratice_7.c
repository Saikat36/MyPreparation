...
| Decimal  |                Binary                                      |
| -------  | ---------------------------------------------------------- |
|          |   Box1(1000)  |   Box2(2000)  |   Box3(3000) |  Box4(4000) |
|          |               |               |              |             |
|          | (2)^32-(2)^25 | (2)^24-(2)^17 | (2)^16-(2)^9 | (2)^8-(2)^0 |
| -------  | ---------------------------------------------------------- |
|   258    |   00000000    |   00000000    |   00000001   |  00000010   |
 ---------------------------------------------------------------------- 
                                      
    Little Endian = 00000010  00000001  00000000  00000000
    Big Endian    = 00000000  00000000  00000001  00000010
 ----------------------------------------------------------------------



| Type          | Address 1000 | Address 1001 | Address 1002 | Address 1003 | *p Value | Output|
| --------------| ------------ | ------------ | ------------ | ------------ | -------- | ------|
| Little Endian | 00000010     | 00000001     | 00000000     | 00000000     | 00000010 |   2   |
| Big Endian    | 00000000     | 00000000     | 00000001     | 00000010     | 00000000 |   0   |
